...
contract SimpleBank{
   ...
   address public owner;
    ...
    function deposit(uint cash) public payable isEnrolled returns (uint)  {
        /* Add the amount to the user's balance, call the event associated with a deposit,
          then return the balance of the user */
    //    msg.value
     
     
     require(cash != 0 , "deposit amount cannot be zero");
     balances[msg.sender] =  balances[msg.sender].add(cash) ;
